...
public class MyString2 {
	...
	private int palabrasContadas;
	private int letrasDiferentesContadas;
	private Map<String, Integer> frecuenciaPalabras;
	private Map<Character, Integer> frecuenciaLetras;
	private boolean esPalindromo;
	
	
	public MyString2(String cadena) {
		this.cadena=cadena;
		this.palabrasContadas=contarPalabras(cadena);
		this.letrasDiferentesContadas=contarLetrasDiferentes(cadena);
		this.frecuenciaPalabras=contarFrecuenciaPalabras(cadena);
		this.frecuenciaLetras=contarFrecuenciaLetras(cadena);
		this.esPalindromo=esPalindroma(cadena);
	}
	...
	public int getPalabrasContadas() {
		return palabrasContadas;
	}

	public int getLetrasDiferentesContadas() {
		return letrasDiferentesContadas;
	}

	public Map getFrecuenciaPalabras() {
		return frecuenciaPalabras;
	}

	public Map getFrecuenciaLetras() {
		return frecuenciaLetras;
	}
